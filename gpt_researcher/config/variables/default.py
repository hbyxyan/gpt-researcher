...
DEFAULT_CONFIG: BaseConfig = {
    ...
    "SMART_LLM": "dashscope:qwen-plus-latest",  # Has support for long responses (2k+ words).
    "STRATEGIC_LLM": "dashscope:qwen-plus-latest",  # Can be used with o1 or o3, please note it will make tasks slower.
